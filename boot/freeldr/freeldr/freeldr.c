...
FIELD_TRANSLATOR MbrPteField[] = {
    FIELD_TRANSLATOR_ENTRY(PARTITION_TABLE_ENTRY, BootIndicator, FIELD_BYTE_TYPE_LITTLE_ENDIAN),

    FIELD_TRANSLATOR_ENTRY(PARTITION_TABLE_ENTRY, StartHead, FIELD_BYTE_TYPE_LITTLE_ENDIAN),
    FIELD_TRANSLATOR_ENTRY(PARTITION_TABLE_ENTRY, StartSector, FIELD_BYTE_TYPE_LITTLE_ENDIAN),
    FIELD_TRANSLATOR_ENTRY(PARTITION_TABLE_ENTRY, StartCylinder, FIELD_BYTE_TYPE_LITTLE_ENDIAN),

    FIELD_TRANSLATOR_ENTRY(PARTITION_TABLE_ENTRY, SystemIndicator, FIELD_BYTE_TYPE_LITTLE_ENDIAN),

    FIELD_TRANSLATOR_ENTRY(PARTITION_TABLE_ENTRY, EndHead, FIELD_BYTE_TYPE_LITTLE_ENDIAN),
    FIELD_TRANSLATOR_ENTRY(PARTITION_TABLE_ENTRY, EndSector, FIELD_BYTE_TYPE_LITTLE_ENDIAN),
    FIELD_TRANSLATOR_ENTRY(PARTITION_TABLE_ENTRY, EndCylinder, FIELD_BYTE_TYPE_LITTLE_ENDIAN),

    FIELD_TRANSLATOR_ENTRY(PARTITION_TABLE_ENTRY, SectorCountBeforePartition, FIELD_BYTE_TYPE_LITTLE_ENDIAN),
    FIELD_TRANSLATOR_ENTRY(PARTITION_TABLE_ENTRY, PartitionSectorCount, FIELD_BYTE_TYPE_LITTLE_ENDIAN),
};

FIELD_TRANSLATOR MbrField[] = {
    FIELD_TRANSLATOR_ENTRY(MASTER_BOOT_RECORD, MasterBootRecordCodeAndData, FIELD_BYTE_TYPE_BUFFER),
    FIELD_TRANSLATOR_STRUCT_ARRAY(MASTER_BOOT_RECORD, PartitionTable, MbrPteField),
    FIELD_TRANSLATOR_ENTRY(MASTER_BOOT_RECORD, Signature, FIELD_BYTE_TYPE_LITTLE_ENDIAN),
    FIELD_TRANSLATOR_ENTRY(MASTER_BOOT_RECORD, Reserved, FIELD_BYTE_TYPE_LITTLE_ENDIAN),
    FIELD_TRANSLATOR_ENTRY(MASTER_BOOT_RECORD, MasterBootRecordMagic, FIELD_BYTE_TYPE_LITTLE_ENDIAN),
};
...
VOID __cdecl BootMain(IN PCCH CmdLine)
{
    ...
    MASTER_BOOT_RECORD Test;
    DumpStructBytes(MbrField, &Test);
