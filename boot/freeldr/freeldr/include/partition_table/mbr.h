...
/*
 * Define the structure of the extended boot record
 */
typedef struct _EXTENDED_BOOT_RECORD
{
    UCHAR ExtendedBootRecordCodeAndData[0x1be];
    PARTITION_TABLE_ENTRY PartitionTable[2];
    UCHAR Padding[0x20];
    USHORT ExtendedBootRecordMagic;
} EXTENDED_BOOT_RECORD, *PEXTENDED_BOOT_RECORD;
